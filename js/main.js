...
$(function () {
    ...
    $.when($.ajax({
        url: "./backend/feedbacks/freelancer.php",
        dataType: 'text',
        success: function (data) {
            ...
            $.each(data, function (index, feedback) {
                injectHtml = injectHtml + "<li><span>" + feedback.owner + ":&nbsp</span><span>" + feedback.feedback + "</span></li>";
            });
            document.getElementById('freelancer-feedbacks').innerHTML = injectHtml;
        }
    })).done(function () {
        $( "#loader-feedback" ).addClass( "loader-wrap hide-me" );
        $( "#feedback-area" ).removeClass( "hide-me" );
        refreshScrollBars();
